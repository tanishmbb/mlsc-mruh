    ...
    >
      ...
      >
        ...
        <div className="p-6">
          ...
          <p className="text-blue-600 font-semibold mb-1 font-body">{member.role}</p>
          <p className="text-slate-500 text-sm mb-4 font-body">{member.designation}</p>
        ...
        >
          <div className="text-center">
            <p className="text-sm text-slate-600 font-body">Connect with me on social media</p>
          </div>
        </motion.div>
      </motion.div>
    </motion.div>
